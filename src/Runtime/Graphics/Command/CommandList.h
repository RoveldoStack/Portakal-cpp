...
#include <Runtime/Graphics/Resource/ResourceSubmitStage.h>
...
namespace Portakal
{
	...
	public:
		...
		FORCEINLINE void CommitResourceTable(const ResourceSubmitStage stage,const unsigned int slotIndex,const ResourceTable* pTable);
	...
	protected:
		...
		FORCEINLINE virtual void CommitResourceTableCore(const ResourceSubmitStage stage,const unsigned int slotIndex,const ResourceTable* pTable) = 0;
