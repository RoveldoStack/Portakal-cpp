...
namespace Portakal
{
	enum class PORTAKAL_API MeshLoadFlags : long long
	{
        // -------------------------------------------------------------------------
       ...
       */
        ...
        */
        RemoveDegeneratePolygons = 0x10000,
        ...
        */
         ...
         * properly.
         */
        GenerateTextureCoordinates = 0x40000,
        ...
        */
        TransformTextureCoordinates = 0x80000,
        ...
        */
         ...
         * applications.
        */
        FlipTextureCoordinates = 0x800000,
         ...
         * @endcode
        */
        FlipFaceWindingOrder = 0x1000000,
    ...
    FORCEINLINE static MeshLoadFlags operator |(const MeshLoadFlags a, const MeshLoadFlags b)
    {
        return (MeshLoadFlags)((long long)a | (long long)b);
    }

    FORCEINLINE static bool operator &(const MeshLoadFlags a, const MeshLoadFlags b)
    {
