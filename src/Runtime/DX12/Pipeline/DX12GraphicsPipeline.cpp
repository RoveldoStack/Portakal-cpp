...
namespace Portakal
{
	DX12GraphicsPipeline::DX12GraphicsPipeline(const GraphicsPipelineCreateDesc& desc, DX12Device* pDevice) : Pipeline(desc)
	{
		...
		//*/
		//for (unsigned int stageIndex = 0; stageIndex < desc.ResourceState.Stages.GetCursor(); stageIndex++)
		//{
		//	/*
		//	* Get stage info
		//	*/
		//	PipelineResourceStageDesc& stageDesc = desc.ResourceState.Stages[stageIndex];

		//	for (unsigned int tableIndex = 0; tableIndex < desc.ResourceState.Stages.GetCursor(); tableIndex++)
		//	{
